...
import { PeriodPage } from "./pages/classes-page/pages/period/period";
import { ClassSchedulePage } from "./pages/classes-page/pages/class-schedule/class-schedule";
import { StudyPlan } from "./pages/study-plan/study-plan";
import { AgeGroupSubject } from "./pages/age-group-subject/age-group-subject";
import { ClassStudent } from "./pages/classes-page/pages/class-student/class-student";
import { ClassesPage } from "./pages/classes-page/classes-page";
import { ClassInfoPage } from "./pages/classes-page/pages/class-info-page/class-info-page";
